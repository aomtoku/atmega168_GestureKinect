...
//communication by UART AVR--Bluetooth
struct termios oldtio,newtio;
int fd;

#define SERIAL_PORT "/dev/tty.FireFly-AEB8-SPP"
...
void UARTsetup(void)
{
	...
	printf("open error: Serial communication has troubles\n");
	exit(1);
    }
